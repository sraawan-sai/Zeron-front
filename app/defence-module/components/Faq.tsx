...
const faqs = [
  {
    ...
    answer:
      "Attack Surface Management (ASM) is a continuous process of identifying, analyzing, and monitoring an organization's digital assets to uncover vulnerabilities and reduce potential attack vectors.",
  },
  {
      ...
      <div className="flex flex-col items-start gap-[24px] w-full max-w-[1140px]">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <h2
                className={`text-[22px] leading-[130%] ${
              ...
              <svg
                ...
                fill="none"
                stroke={
                  openIndex === index ? "white" : "rgba(255, 255, 255, 0.6)"
                }
                strokeWidth="2"
                viewBox="0 0 24 24"
