...
const resources = [
  {
    id: 1,
    image: "/images/whitepapers/card.jpg",
    category: "TAG NAME",
    headline: "QBER",
...
export default function FeaturedResources() {
  ...
  {resource.headline}
              ...
              <div className="flex flex-row items-center gap-[12px] w-[191px] h-[18px]">
               <span className="text-[#0F6CBD]  text-[15px] font-medium uppercase tracking-[-0.03em] w-[56px] h-[18px]">
                  Timeline
               </span>
               <div className="w-[6px] h-[6px] bg-white rounded-full" />
                 <span className="text-white/60  text-[15px] font-medium uppercase tracking-[-0.03em] w-[105px] h-[18px]">
                {resource.category}
              </span>
              </div>
