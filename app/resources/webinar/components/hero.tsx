...
const Hero = () => {
  return (
    <div
      className="relative w-full max-w-[1440px] h-auto min-h-[614px] bg-cover bg-center mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between px-4 py-8 lg:px-0 lg:py-0"
      style={{ backgroundImage: "url('/images/webinar/webinarbg.png')" }}
    >
      {/* Left Text Block */}
      <div className="w-full lg:w-[608px] flex flex-col justify-center items-start gap-4 lg:gap-[6px] mt-6 lg:mt-0 px-2 lg:px-0 lg:absolute lg:left-[111px] lg:top-[calc(52%-162.5px+50px)]">
        {/* Tagline & Date */}
        ...
        <h1 className="text-white font-medium text-[32px] lg:text-[46px] leading-[42px] lg:leading-[66px] tracking-[-0.0625rem] font-poppins">
          Lorem Ipsum is simply<br className="hidden lg:block" /> dummy text <span className="text-white">.</span>
        </h1>

        {/* Paragraph */}
        <p className="text-[#C1C1C1] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[26px] font-normal">
          Lorem Ipsum is simply dummy text of the printing and typesetting<br className="hidden lg:block" />
          industry. Lorem Ipsum has been the industry's standard dummy<br className="hidden lg:block" />
      ...
      {/* Right Image */}
      <div className="w-full lg:w-auto flex justify-center items-center lg:absolute lg:right-[40px] lg:top-1/2 lg:-translate-y-1/2">
        <img
