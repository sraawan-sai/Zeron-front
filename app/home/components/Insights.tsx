...
const Insights = () => {
  return (
    <div className="flex flex-col items-center justify-center mx-auto gap-16 px-4 py-20 overflow-hidden">
      ...
      <motion.div className="mt-20 inline-grid grid-cols-1 md:grid-cols-3 gap-6" initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.2 }} variants={fadeUp}>
