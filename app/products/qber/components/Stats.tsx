...
const QberStats = () => {
  return (
    <div className="w-full flex items-center justify-center bg-[url('/images/bg1.png')] bg-cover bg-center bg-no-repeat py-25 md:px-20">
      <CustomSection className="lg:px-20 flex-col md:flex-row items-center justify-center">
