...
const VendorFeatures = () => {
  const features = [
    {
      title: "Streamlined Vendor Onboarding",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s",
      image: "/images/crpmf2.svg",
    },
    {
      title: "Category-Wise Digital Risk Assessment",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s",
    ...
    {
      title: "Collaborative Evidence Review",
      description:
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s",
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full bg-[#0A0118] px-6 md:px-20 py-24 gap-20">
      ...
      {/* Heading */}
      <h2 className="text-white text-center text-[3rem] tracking-[-1px] leading-[52px] z-10 max-w-[1100px]">
        From Onboarding to Continuous Monitoring – A Unified Approach
      </h2>
      ...
      <div className="grid grid-cols-2 gap-x-10 z-10 max-w-7xl w-full">
        {features.map((feature, idx) => (
          ...
          >
            ...
            <div className="flex-grow max-w-[460px]">
