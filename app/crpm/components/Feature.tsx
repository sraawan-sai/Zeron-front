...
const CyberRiskFeatures: React.FC = () => {
  const features = [
    {
      ...
      description: 'Connect with existing security tools to unify risk management efforts.',
      icon: '/images/crpmf1.svg',
    },
    {
      title: 'Extensive Attack Surface Mapping',
      description: 'Identify both internal and external vulnerabilities in real-time.',
      icon: '/images/crpmf2.svg',
    },
    {
      title: 'Robust Risk Register',
      description: 'Maintain a centralized risk repository with real-time tracking and updates.',
      icon: '/images/crpmf3.svg',
    },
    {
      title: 'Automated Compliance Mapping',
      description: 'Align security controls with global regulatory frameworks effortlessly.',
      icon: '/images/crpmf4.png',
    },
    {
      title: 'Granular Risk Quantification',
      description: 'Quantifies cyber risks across governance, technology, and people, measuring threats like ransomware and phishing.',
      icon: '/images/crpmf5.png',
    },
    {
      title: 'AI-Powered Assistance',
      description: 'Optimizes security posture with tailored recommendations and detailed reports for smarter decision-making.',
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center bg-[#0A0118] px-6 md:px-20 py-24 gap-16">
      ...
      {/* Title Section */}
      <h2 className="relative z-10 text-white text-4xl md:text-5xl font-medium text-center leading-tight max-w-5xl">
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-7xl w-full">
        {features.map((feature, idx) => (
          ...
          >
            ...
            {/* Title */}
            <h3 className="text-white text-2xl font-semibold leading-snug">{feature.title}</h3>
            {/* Description */}
