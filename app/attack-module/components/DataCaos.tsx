...
const DataChaos = () => {
  return (
    <div className="flex flex-col items-center justify-center container mx-auto py-20">
      ...
      <div className="px-4 mt-25 w-full flex flex-col gap-6 items-center justify-center">
        {dataSections.map((section, index) => (
          <div
            key={index}
            className="px-4 py-6 relative w-full max-w-[1248px] min-h-[430px] flex flex-col gap-5 md:gap-0 md:flex-row items-center md:justify-between"
          >
