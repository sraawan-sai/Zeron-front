  ...
  return (
    <div className="min-h-screen w-full flex relative items-center pt-38 xs:pt-48 md:pt-34">
      <Image
        ...
        alt=""
        fill={true}
        className="object-top object-cover opacity-80 -z-1"
      />
      <CustomSection className="py-10">
        <div className="xl:px-25 w-full flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-10 xl:gap-29">
          <div className="w-full max-w-fit flex flex-col gap-25">
            <div className="flex flex-col gap-4">
              <p className="text-[2rem] leading-[130%]">
              ...
              {contactInfo.map((info, index) => (
                <div key={index} className="flex flex-col gap-7.5">
                  <div className="backdrop-blur-[30%] px-4 py-5 w-full max-w-[360px] flex flex-col gap-3.5 rounded-[16px] bg-[#19133F]/50">
                    ...
                    <p className="text-[1.5rem] leading-[130%] tracking-[-2%]">
                      {info.value}
                    </p>
                  </div>
          ...
          <div className="w-full flex flex-col items-center justify-center gap-25 lg:gap-0">
            <div className="backdrop-blur-[30%] px-4 md:px-17.5 py-15 w-full max-w-[670px] flex flex-col gap-3.5 rounded-[20px] bg-[#19133F]/50">
            ...
            <div className="lg:hidden grid gird-cols-1 md:grid-cols-3 gap-7.5">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex flex-col gap-7.5">
                  <div className="backdrop-blur-[30%] px-4 py-5 w-full max-w-[360px] flex flex-col gap-3.5 rounded-[16px] bg-[#19133F]/50">
                    <p className="text-white/60 font-medium leading-[120%] tracking-[-3%]">
