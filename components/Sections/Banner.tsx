...
const Banner = ({
  imageLeft,
  imageRight,
  title = "Experience Zeron in Action – Get Your Personalized Walkthrough",
}: BannerProps) => {
  return (
    <div className="relative w-full flex items-center justify-center bg-[url('/images/bg1.png')] bg-cover bg-bottom bg-no-repeat py-25 px-4 md:px-20 overflow-clip">
      <div
        ...
        className="absolute -bottom-10 -left-40 bg-cover bg-center bg-no-repeat h-full w-full max-w-[400px] opacity-80 -rotate-10 mix-blend-color-dodge"
      />
      <div
        style={{ backgroundImage: `url(${imageRight})` }}
        className="absolute -top-10 -right-10 bg-[url('/images/stripes.png')] bg-cover bg-center bg-no-repeat h-[200px] w-[200px] opacity-80 -rotate-90 mix-blend-color-dodge"
      />
